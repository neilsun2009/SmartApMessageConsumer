...
public class TermianalFeatureConsumer extends Thread{
	...
	private final String TOPIC = "TERMINAL_FEATURE";
	
	private final String DATA_TYPE = "SMART_EP_1001";
    ...
    public TermianalFeatureConsumer() {
			...
			if (item.getIdentifier() != null
				...
				try {
						if(pool.execBatchSql(sqlList))
							System.out.println("TERMINAL_FEATURE：WriteIntoNormalTableSucceed");
						else
							System.out.println("TERMINAL_FEATURE：WriteIntoNormalTableFailed");
