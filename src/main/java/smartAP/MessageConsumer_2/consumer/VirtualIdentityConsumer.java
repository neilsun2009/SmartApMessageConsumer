...
public class VirtualIdentityConsumer extends Thread{
	...
	private final String TOPIC = "VIRTUAL_IDENTITY";
	
	private final String DATA_TYPE = "SMART_EXT_EP";
    ...
    public VirtualIdentityConsumer() {
			...
			if (item.getIdentifier() != null
				...
				try {
						if(pool.execBatchSql(sqlList))
							System.out.println("VIRTUAL_IDENTITY：WriteIntoNormalTableSucceed");
						else
							System.out.println("VIRTUAL_IDENTITY：WriteIntoNormalTableFailed");
